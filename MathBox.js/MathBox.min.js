...
q,v,c,h);this.labels=new MathBox.Renderable.Labels(g,l,u,e,h)}});MathBox.Axis.validateArgs=function(a){"number"==typeof a&&(a={axis:a});return a};MathBox.Primitive.types.axis=MathBox.Axis;MathBox.Grid=function(a){null!==a&&MathBox.Primitive.call(this,a)};
...
g[12][1],g[13][1],g[14][1],g[15][1]);this.matrixZ.set(g[0][2],g[1][2],g[2][2],g[3][2],g[4][2],g[5][2],g[6][2],g[7][2],g[8][2],g[9][2],g[10][2],g[11][2],g[12][2],g[13][2],g[14][2],g[15][2]);var l=this.coefficients;this.matrixX.multiplySelf(l).transpose().multiplySelf(l);this.matrixY.multiplySelf(l).transpose().multiplySelf(l);this.matrixZ.multiplySelf(l).transpose().multiplySelf(l);var l={bezierSurfaceX:this.matrixX,bezierSurfaceY:this.matrixY,bezierSurfaceZ:this.matrixZ},m=c[0][0],q=c[1][0],v=(c[0][1]-
m)/(h[0]-1),u=(c[1][1]-q)/(h[1]-1),t=0;_.loop(h[1],function(b){m=c[0][0];_.loop(h[0],function(b){a[t].set(m,q,0);m+=v;t++}.bind(this));q+=u}.bind(this));l={uniforms:l,shaders:{position:function(a,b){f?(a.snippet("bezierSurface"+e),a.group(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.combine()):(a.snippet("bezierSurface"+e).snippet("mathTransform"),b.viewport(a))}}};this.mesh.set(l);this.line.set(l);
...
d.className="mathbox-wrap";d.style.position="relative";d.style.display="inline-block";d.style.left="-50%";d.style.top="-.5em";c.push(k);e.add(k)})},adjust:function(a,b,c,d,e){var f=this.get(),h=this.points;b=this.sprites;var k=this.callback,g=f.decimals,l=this.style.get("opacity"),m=window.MathJax&&MathJax.Hub,q=1/Math.log(10);_.each(b,function(b,c){b.position.copy(h[c]);a.to(b.position);e.matrix.multiplyVector3(b.position);b.distance=f.distance;b.opacity=l;var d="";if(k){d=k(c);void 0===d&&(d="");
if(+d==d){var r=+d;if(0!=r)var d=0>r?-1:1,r=Math.abs(r),w=Math.pow(10,g-1-Math.floor(Math.log(r)*q)),d=r=d*Math.round(w*r)/w}m||(d=(""+d).replace(/^-/,"\u2013"))}b.content!==d&&(r=b.element.children[0],b.content=d,b.measure=!0,m?(r.innerHTML="\\("+d+"\\)",MathJax.Hub.queue.Push(["Typeset",MathJax.Hub,r])):r.innerHTML=d)});MathBox.Renderable.prototype.adjust.call(this,a)}});
